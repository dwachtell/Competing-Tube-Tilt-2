...
jsPsych.plugins["davis-resize"] = (function() {
    ...
    plugin.trial = function(display_element, trial) {
        ...
        function end_trial() {
            ...
            screenWidth_Inches = window.innerWidth * (trial.item_width / final_width_px); // pixels * inches / pixels
            screenHeight_Inches = window.innerHeight * (trial.item_height / final_height_px); // pixels * inches / pixels
            screenDiagonal_Inches = Math.sqrt(Math.pow(screenWidth_Inches, 2) + Math.pow(screenHeight_Inches, 2)); // c = sqrt(a^2 + b^2)
            ...
            var trial_data = {
                ...
                'screenWidth_Inches': screenWidth_Inches,
                'screenHeight_Inches': screenHeight_Inches,
                'screenDiagonal_Inches': screenDiagonal_Inches,
            }
